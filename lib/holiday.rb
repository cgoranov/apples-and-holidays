...
def all_winter_holiday_supplies(holiday_hash)
  ...
  holiday_hash.each do |season, holiday|
    if season == :winter
      holiday.each do |holiday_name, holiday_supply|
        all_winter_supplies << holiday_supply
      end
    end
  end
  ...
  holiday_hash.each do |season, holiday|
    puts "#{season.capitalize}:"
      holiday.each do |holidays, supply|
        puts "  " + "#{holidays}: ".gsub("_", " ").split.map(&:capitalize).join(" ") + " #{supply.join(", ")}"
    end
  end
end
...
def all_holidays_with_bbq(holiday_hash)
  ...
  holiday_hash.each do  |seasons, holiday|
    holiday.each do |holidays, supply|
      array << holidays if supply.include?("BBQ")
    end
  end
  return array
end
